...
void build_wall_h(uint16_t x, uint16_t y, uint16_t);
void build_wall_v(uint16_t x, uint16_t y, uint16_t);
void delete_wall_h(uint16_t x, uint16_t y);
void delete_wall_v(uint16_t x, uint16_t y);
char check_win_condition(char);
void create_menu(void);
void selection_board_down(void);
void selection_board_up(void);
void choose_player_mode(void);
void set_num_boards(void);
void init_single_player_human(void);
void init_single_player_npc(void);
#endif 
